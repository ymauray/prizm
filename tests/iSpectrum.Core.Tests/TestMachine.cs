...
{
    public static void TypeText(this Spectrum48 spectrum, string text)
    {
    ...
    /// </summary>
    public static void Type(this Spectrum48 spectrum, params SpectrumKey[] keys)
    {
    ...
    public static void RunFrames(this Spectrum48 spectrum, int count)
    {
